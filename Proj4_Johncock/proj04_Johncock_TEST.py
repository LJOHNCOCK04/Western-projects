...
# importing the os for functins in the code.
import os
...
# verifing that the file actually exists
...
def main():
    ...
    try:
        ...
        with open(old_file, "r") as old_f, open(new_file, "w") as new_f:
            ...
            # Finds the infomation for the line
                ...
                while True:
                    command = input("Enter a command (a,c,d,w): ").lower().strip()
                     ...
                     # Valedating the command from user.
                    ...
                    # Withdrawal --------------------------------------------------------------
                        ...
                        while True:
                            try:
                                ...
                                # Checking for valid positive ammount.
                                if amount <= 0:
                                    print("INVALID INPUT: Please enter a numeric value greater than 0.")
                                    continue
                                # preventing overdrawing the acocunt>
                    ...
                    # Close Account --------------------------------------------------------------
                        ...
                        if balance < 0.005:
                            ...
                            write_record = False # not writing closed account to the new file
                            continue
                        else:
                    ...
                    # Advance --------------------------------------------------------------
                        ...
                        #Writing the accounts updated record.
                        if line is not None:
                            new_f.write(f"{acct_num:06d} {balance:010.2f} {name}\n")
                            print(f"New balance: {acct_num:06d} {balance:.2f} {name}")
                        break
            
            # Confermation that the lines were all processed and confirms the completions of the program.
